-- Seed data for Origen Bistro & Bakery.
-- Run after supabase/schema.sql.
-- All content is global. Supabase Auth users are administrators only.
...
select
  ...
  '124 Artisan Avenue, St. Catharines, Ontario',
  'Mon-Fri 7:30 AM - 6:00 PM' || chr(10) || 'Sat-Sun 8:00 AM - 4:00 PM',
  'Mon-Fri 7:30 AM - 6:00 PM' || chr(10) || 'Sat-Sun 8:00 AM - 4:00 PM',
  'Lun-Vie 7:30 AM - 6:00 PM' || chr(10) || 'Sab-Dom 8:00 AM - 4:00 PM',
  ''
...
set
  ...
  hours = 'Mon-Fri 7:30 AM - 6:00 PM' || chr(10) || 'Sat-Sun 8:00 AM - 4:00 PM',
  hours_en = 'Mon-Fri 7:30 AM - 6:00 PM' || chr(10) || 'Sat-Sun 8:00 AM - 4:00 PM',
  hours_es = 'Lun-Vie 7:30 AM - 6:00 PM' || chr(10) || 'Sab-Dom 8:00 AM - 4:00 PM',
...
insert into public.hero_content (
  ...
  primary_button_label_es,
  primary_button_url,
  secondary_button_label,
  secondary_button_label_en,
  secondary_button_label_es,
...
select
  ...
  'Our story',
  'Nuestra historia',
  'Origen Bistro & Bakery nace como un lugar de encuentro entre la panaderia artesanal y una cocina de bistro luminosa. Trabajamos con masas lentas, ingredientes de temporada y una estetica calida que invita a quedarse.' || chr(10) || chr(10) || 'La marca celebra lo hecho con tiempo: panes de corteza profunda, pasteleria delicada, cafe servido con precision y platos pensados para compartir.',
  'Origen Bistro & Bakery is a meeting place between artisan bakery and bright bistro cooking. We work with slow doughs, seasonal ingredients and a warm boutique aesthetic made for lingering.' || chr(10) || chr(10) || 'The brand celebrates what is made with time: deep-crusted bread, delicate pastry, carefully served coffee and plates designed to share.',
  'Origen Bistro & Bakery nace como un lugar de encuentro entre la panaderia artesanal y una cocina de bistro luminosa. Trabajamos con masas lentas, ingredientes de temporada y una estetica calida que invita a quedarse.' || chr(10) || chr(10) || 'La marca celebra lo hecho con tiempo: panes de corteza profunda, pasteleria delicada, cafe servido con precision y platos pensados para compartir.',
  'https://images.unsplash.com/photo-1517433670267-08bbd4be890f?auto=format&fit=crop&w=1200&q=85',
  'Artesania lenta' || chr(10) || 'Ingredientes honestos' || chr(10) || 'Hospitalidad calida' || chr(10) || 'Estetica boutique',
  'Slow craft' || chr(10) || 'Honest ingredients' || chr(10) || 'Warm hospitality' || chr(10) || 'Boutique aesthetic',
  'Artesania lenta' || chr(10) || 'Ingredientes honestos' || chr(10) || 'Hospitalidad calida' || chr(10) || 'Estetica boutique',
  'Ver menu',
  'View menu',
  'Ver menu',
...
set
  ...
  page_body = 'Origen Bistro & Bakery nace como un lugar de encuentro entre la panaderia artesanal y una cocina de bistro luminosa. Trabajamos con masas lentas, ingredientes de temporada y una estetica calida que invita a quedarse.' || chr(10) || chr(10) || 'La marca celebra lo hecho con tiempo: panes de corteza profunda, pasteleria delicada, cafe servido con precision y platos pensados para compartir.',
  page_body_en = 'Origen Bistro & Bakery is a meeting place between artisan bakery and bright bistro cooking. We work with slow doughs, seasonal ingredients and a warm boutique aesthetic made for lingering.' || chr(10) || chr(10) || 'The brand celebrates what is made with time: deep-crusted bread, delicate pastry, carefully served coffee and plates designed to share.',
  page_body_es = 'Origen Bistro & Bakery nace como un lugar de encuentro entre la panaderia artesanal y una cocina de bistro luminosa. Trabajamos con masas lentas, ingredientes de temporada y una estetica calida que invita a quedarse.' || chr(10) || chr(10) || 'La marca celebra lo hecho con tiempo: panes de corteza profunda, pasteleria delicada, cafe servido con precision y platos pensados para compartir.',
  secondary_image_url = 'https://images.unsplash.com/photo-1517433670267-08bbd4be890f?auto=format&fit=crop&w=1200&q=85',
  values = 'Artesania lenta' || chr(10) || 'Ingredientes honestos' || chr(10) || 'Hospitalidad calida' || chr(10) || 'Estetica boutique',
  values_en = 'Slow craft' || chr(10) || 'Honest ingredients' || chr(10) || 'Warm hospitality' || chr(10) || 'Boutique aesthetic',
  values_es = 'Artesania lenta' || chr(10) || 'Ingredientes honestos' || chr(10) || 'Hospitalidad calida' || chr(10) || 'Estetica boutique',
  cta_label = 'Ver menu',
...
-- Catering
insert into public.catering_content (
  hero_image_url,
  title,
  title_en,
  title_es,
...
select
  ...
  'Catering by Origen',
  'Catering de Origen',
  'Bakery boxes, brunch spreads and bistro-style catering for thoughtful gatherings.',
  'Bakery boxes, brunch spreads and bistro-style catering for thoughtful gatherings.',
  'Bakery boxes, brunch y catering estilo bistro para reuniones especiales.',
  'Bring the warmth of Origen to meetings, celebrations and private events across St. Catharines and Niagara. We prepare polished bakery boxes, brunch tables, coffee service and seasonal menus with the same boutique care as our dining room.',
  'Bring the warmth of Origen to meetings, celebrations and private events across St. Catharines and Niagara. We prepare polished bakery boxes, brunch tables, coffee service and seasonal menus with the same boutique care as our dining room.',
  'Lleva la calidez de Origen a reuniones, celebraciones y eventos privados en St. Catharines y Niagara. Preparamos bakery boxes, mesas de brunch, servicio de cafe y menus de temporada con el mismo cuidado boutique de nuestra sala.',
  'https://images.unsplash.com/photo-1519671482749-fd09be7ccebf?auto=format&fit=crop&w=1200&q=85',
  'https://images.unsplash.com/photo-1488477181946-6428a0291777?auto=format&fit=crop&w=900&q=85' || chr(10) || 'https://images.unsplash.com/photo-1525351484163-7529414344d8?auto=format&fit=crop&w=900&q=85',
  'Corporate breakfasts' || chr(10) || 'Brunch gatherings' || chr(10) || 'Bakery boxes' || chr(10) || 'Private celebrations' || chr(10) || 'Coffee service',
  'Corporate breakfasts' || chr(10) || 'Brunch gatherings' || chr(10) || 'Bakery boxes' || chr(10) || 'Private celebrations' || chr(10) || 'Coffee service',
  'Desayunos corporativos' || chr(10) || 'Reuniones de brunch' || chr(10) || 'Bakery boxes' || chr(10) || 'Celebraciones privadas' || chr(10) || 'Servicio de cafe',
  'Morning pastry box' || chr(10) || 'Signature brunch table' || chr(10) || 'Coffee and sweets service' || chr(10) || 'Seasonal bistro menu',
  'Morning pastry box' || chr(10) || 'Signature brunch table' || chr(10) || 'Coffee and sweets service' || chr(10) || 'Seasonal bistro menu',
  'Caja de pasteleria de manana' || chr(10) || 'Mesa brunch signature' || chr(10) || 'Servicio de cafe y dulces' || chr(10) || 'Menu bistro de temporada',
  'Request catering',
  'Request catering',
  'Solicitar catering',
  '/contact',
  '19050001224',
  true
where not exists (select 1 from public.catering_content);

update public.catering_content
set
  ...
  gallery_urls = 'https://images.unsplash.com/photo-1488477181946-6428a0291777?auto=format&fit=crop&w=900&q=85' || chr(10) || 'https://images.unsplash.com/photo-1525351484163-7529414344d8?auto=format&fit=crop&w=900&q=85',
  service_types = 'Corporate breakfasts' || chr(10) || 'Brunch gatherings' || chr(10) || 'Bakery boxes' || chr(10) || 'Private celebrations' || chr(10) || 'Coffee service',
  service_types_en = 'Corporate breakfasts' || chr(10) || 'Brunch gatherings' || chr(10) || 'Bakery boxes' || chr(10) || 'Private celebrations' || chr(10) || 'Coffee service',
  service_types_es = 'Desayunos corporativos' || chr(10) || 'Reuniones de brunch' || chr(10) || 'Bakery boxes' || chr(10) || 'Celebraciones privadas' || chr(10) || 'Servicio de cafe',
  packages = 'Morning pastry box' || chr(10) || 'Signature brunch table' || chr(10) || 'Coffee and sweets service' || chr(10) || 'Seasonal bistro menu',
  packages_en = 'Morning pastry box' || chr(10) || 'Signature brunch table' || chr(10) || 'Coffee and sweets service' || chr(10) || 'Seasonal bistro menu',
  packages_es = 'Caja de pasteleria de manana' || chr(10) || 'Mesa brunch signature' || chr(10) || 'Servicio de cafe y dulces' || chr(10) || 'Menu bistro de temporada',
...
where not exists (
  ...
  where image_url = 'https://images.unsplash.com/photo-1517433367423-c7e5b0f35086?auto=format&fit=crop&w=900&q=85'
);
...
where not exists (
  select 1 from public.gallery_images
  where image_url = 'https://images.unsplash.com/photo-1509440159596-0249088772ff?auto=format&fit=crop&w=900&q=85'
);
...
-- Order Platforms
insert into public.order_platforms (
  name,
  order_url,
  button_text_en,
  button_text_es,
...
values
  ...
  ('catering', 'Catering | Origen Bistro & Bakery', 'Catering | Origen Bistro & Bakery', 'Bakery boxes, brunch catering and corporate catering in St. Catharines.', 'Bakery boxes, brunch catering y catering corporativo en St. Catharines.', true, true),
...
insert into public.local_seo_blocks (
  page_target,
  heading_en,
  heading_es,
  content_en,
...
select
  ...
  true
where not exists (
  select 1 from public.local_seo_blocks
  where page_target = 'home'
    and heading_en = 'Bakery and brunch in St. Catharines'
);
